<template>
  <div>
    <h2 id="page-heading" data-cy="StudentHeading">
      <span v-text="t$('studentsApp.student.home.title')" id="student-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('studentsApp.student.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'StudentCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('studentsApp.student.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && students && students.length === 0">
      <span v-text="t$('studentsApp.student.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="students">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('studentsApp.student.firstName')"></span></th>
            <th scope="row"><span v-text="t$('studentsApp.student.lastName')"></span></th>
            <th scope="row"><span v-text="t$('studentsApp.student.email')"></span></th>
            <th scope="row"><span v-text="t$('studentsApp.student.age')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="studentsApp.student.delete.question" data-cy="studentDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-student-heading" v-text="t$('studentsApp.student.delete.question', { id: removeId })"></p>
      </div>
