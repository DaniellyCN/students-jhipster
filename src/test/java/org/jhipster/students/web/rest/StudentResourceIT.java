...
import static org.jhipster.students.web.rest.TestUtil.createUpdateProxyForBean;
...
import org.jhipster.students.IntegrationTest;
...
class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).email(DEFAULT_EMAIL).age(DEFAULT_AGE);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).age(UPDATED_AGE);
        return student;
    }
    ...
    void putExistingStudent() throws Exception {
        ...
        updatedStudent.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).age(UPDATED_AGE);
    ...
    void partialUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL);
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).age(UPDATED_AGE);
