...
describe('Student e2e test', () => {
  ...
  const studentSample = { firstName: 'Lolita', lastName: 'Franecki', email: 'Zander_Durgan98@gmail.com' };
  ...
  describe('new Student page', () => {
    ...
    it('should create an instance of Student', () => {
      cy.get(`[data-cy="firstName"]`).type('Reggie');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Reggie');

      cy.get(`[data-cy="lastName"]`).type('Hodkiewicz');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Hodkiewicz');

      cy.get(`[data-cy="email"]`).type('Winnifred_Goldner28@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Winnifred_Goldner28@hotmail.com');

      cy.get(`[data-cy="age"]`).type('29979');
      cy.get(`[data-cy="age"]`).should('have.value', '29979');
